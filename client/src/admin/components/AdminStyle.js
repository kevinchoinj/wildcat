...
class AdminStyle extends React.Component {
  onSortItems = (items) => {
    this.props.adminActions.sendStyleText(items);
  }
  removeText = (location) => {
    this.props.adminActions.removeStyleText(location);
  }
  render() {
    const {
      items,
